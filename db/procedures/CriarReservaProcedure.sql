--procedura para criar reservas que recebe os parametros da aplica��o python
/*
...
BEGIN
	...
	BEGIN
		...
		--guarda o valor gerado pelo trigger MakeID numa tabela tempor�ria
	...
	BEGIN
		...
		BEGIN 
			...
			--OUTRA RESERVA
				...
				--alterar o assigned_to de sim para nao pois agora o uti atual � que tem o equi
			...
			ELSE
			BEGIN
			--quando a nossa prioridade � mais baixa
			--NOSSA RESERVA
				--inserir os dados recebidos a tabela reserva criando uma nova reserva
				INSERT INTO Reserva(idu, data_registo, periodo_uso_inicio, periodo_uso_fim, estado)
				--guarda o valor gerado pelo trigger MakeID numa tabela tempor�ria
		...
		--VER SE O PERIODO DE USO INTERFERE
			...
			IF ( @fim_outro < @fim) --entao a reserva n�o acontece
			BEGIN
				SET @inUse = 'A reserva atual n�o � poss�vel.';
			END
		END
	END
