...
class FrameHome(customtkinter.CTkFrame):
    def __init__(self, parent, row, callback, name):
        ...
        self.buttons['Página Inicial'] = customtkinter.CTkButton(self.container, corner_radius=0, height=40, width=240, border_spacing=10, text="• Página Inicial",
            fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
            anchor="w", command=lambda: callback(name, 'Página Inicial')
        )
        self.buttons['Página Inicial'].grid(row=0, column=0, sticky="ew")
