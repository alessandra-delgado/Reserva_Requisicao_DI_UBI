...
from models import UserDI, Equipment, Requisition
from views.widgets.ctk_date_picker import CTkDatePicker


class FrameRequisitionNew(ctk.CTkScrollableFrame):
    def __init__(self, parent):
        ...
        # Page title
        title = ctk.CTkLabel(self.form_frame, text="Criação de Requisição", text_color="#20558A", font=("", 20, 'bold'))
        ...
        self.scrollableFrame.grid(row=5, column=0, sticky="nsew", padx=5, pady=(3, 0))
        for i in range(self.cols):
            self.scrollableFrame.columnconfigure(i, weight=1)
    ...
    def reload(self, category=None) -> None:
        ...
        l.grid(row=1, column=2, padx=5, pady=5, sticky="w")
        self.add_divider(2)
        ...
        divider.grid(row=1, column=1, rowspan=i, sticky="nse", padx=5)
        divider = ctk.CTkFrame(self.scrollableFrame, width=1, bg_color="#B3CBE5")
